...
This package provides functions for calculating floristic quality metrics based on the 48 regional FQA databases that have been approved for use by the US Army Core of Engineers. 
